//
//  习题10-11 有序表的增删改查操作.c
//  PAT
//
//  Created by Vision on 2022/4/17.
//

#include<stdio.h>
#define MAXN 10000    /* 定义符号常量表示数组a的长度 */

void selectq(int a[], int option, int value); /* 决定对有序数组a进行何种操作的控制函数 */
...
/* 控制函数 */
void selectq(int a[], int option, int value)
{
    int index, value2;
